...
from services.audio.audio import AudioFormat, FORMAT_BACKENDS
import tempfile
import logging
import torchaudio
...
from services.model.custom_component import CustomRQBottleneckTransformer
...
class AudioService:
    ...
    def drive_download(self, repo_id: str, filename: str, local_dir: str):
        pass
    ...
    @staticmethod
    def get_audio_token():
        if AudioService._audio_tokenizer_service is None:
            AudioService._audio_tokenizer_service = AudioService()
        return AudioService._audio_tokenizer_service
